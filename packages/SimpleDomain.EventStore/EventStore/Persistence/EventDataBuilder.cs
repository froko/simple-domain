...
internal class EventDataBuilder
{
    ...
    private EventDataBuilder(IEvent @event, TypeNameStrategy typeNameStrategy)
    {
        this.@event = @event;
    ...
    public static EventDataBuilder Initialize(IEvent @event, TypeNameStrategy typeNameStrategy) =>
