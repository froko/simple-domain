...
public class SnapshotStrategyTests
{
    ...
    {
        var testee = new SnapshotStrategy(10, typeof(MyDynamicEventSourcedAggregateRoot));
        testee.Should().NotBeNull();
    }
    ...
    {
        var testee = new SnapshotStrategy(10, typeof(MyDynamicEventSourcedAggregateRoot));
        testee.AppliesToThisAggregateRoot<MyDynamicEventSourcedAggregateRoot>().Should().BeTrue();
        testee.AppliesToThisAggregateRoot<MyStaticEventSourcedAggregateRoot>().Should().BeFalse();
    ...
    public void VerifiesIfAggregateRootNeedsSnapshot()
    {
        ...
        var aggregateRoot = new MyDynamicEventSourcedAggregateRoot();
