...
abstract) of requirements. Link to (hopefully existing) requirements documents
...
with potential redundancy w.r.t to requirements documents.

See [Introduction and Goals](https://docs.arc42.org/section-1/) in the arc42
documentation.
